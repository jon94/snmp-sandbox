...
os.system(f'docker exec snmp-sand-datadog-agent tcpdump -T snmp -c 30 '
...
os.system("docker exec snmp-sand-datadog-agent bash -c 'agent check snmp -l debug > /tcpdumps/debug_snmp_check.log'")
